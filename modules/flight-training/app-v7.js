globalThis.VeyraFlightTrainingStart=()=>{
  ...
  const state={evaluation:'eval1',scenario:'s1',person:'CM1',index:0,screen:'event',drafts:{},records:[],positions:{},counter:0,deleted:null,guideOpen:false,setupOpen:false,pencil:false};
